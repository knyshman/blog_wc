...
class Menu(models.Model):
    ...
    position = models.SmallIntegerField(verbose_name=_('Позиция'), choices=[('Header', 'Header'), ('Footer', 'Footer')], default='Header')
...
class TextPage(models.Model):
    ...
    url = models.URLField(verbose_name=_('Ссылка'), max_length=100)
    target = models.SmallIntegerField(choices=[(0, '_self'), (1, '_blank')], default=0)
    position = models.SmallIntegerField(verbose_name=_('Позиция'), choices=[(0, 'Header'), (1, 'Footer')], default='Header')
    is_active = models.BooleanField(default=True)
